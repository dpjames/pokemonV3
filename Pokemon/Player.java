...
public class Player extends GameObject{
   ...
   public Player(int x, int y, int width, int height) throws IOException{
      ...
      p.add(new Pokemon("char", new Move[] {new Tackle(),new Move("name"),new Move("name"),new Move("name")} , 25, 100, 50));
      p.add(new Pokemon("squir", new Move[]{new Move("name"),new Move("name"),new Tackle(),new Move("name")} , 25, 100, 10));
      this.party = new Party(p); //make parameter later
   }
